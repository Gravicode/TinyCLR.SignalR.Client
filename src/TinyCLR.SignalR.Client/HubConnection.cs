...
namespace TinyCLR.SignalR.Client
{
    ...
    public class HubConnection
    {
        ...
        public AsyncResult InvokeCoreAsync(string methodName, Type returnType, object[] args, int timeout = 0)
        {
            ...
            else if (timeout == -1) serverTimeout = TimeSpan.Zero; //Timeout.InfiniteTimeSpan;
                        ...
                        switch (invocationMessage.type)
                        {
                            case MessageType.Invocation:
                                ...
                                if (handlerStuff != null)
                                {
                                    ...
                                    Debug.WriteLine("not a valid invocation, types don't match");
                                    break;
                                }

                                Debug.WriteLine("No matchin method found");
                                break;
