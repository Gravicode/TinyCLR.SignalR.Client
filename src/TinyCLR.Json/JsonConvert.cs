                                        ...
                                        if (memberIsProperty)
                                        {
                                            ...
                                            if (val.Value.GetType() != memberType)
                                            {
                                                ...
                                                switch (memberType.Name)
                                                {
                                                    ...
                                                    case nameof(Boolean):
                                                        memberPropSetMethod.Invoke(rootInstance, new object[] { Util.ToBoolean(Convert.ToByte(val.Value.ToString())) });
                                                        break;
                                ...
                                foreach (JsonToken item in memberItems)
                                {
                                    if (item is JsonValue value)
                                    {
                                        ...
                                        if (value.Value.GetType() != memberPropGetMethod.ReturnType)
                                        {
                                            ...
                                            {
                                                memberValueArrayList.Add(Util.ToBoolean(Convert.ToByte(value.Value.ToString())));
                                            }
                                            else
                                            {
                            ...
                            if (item is JsonValue value)
                            {
                                if (value.Value.GetType() != rootType.GetElementType())
                                {
                                    switch (rootType.GetElementType().Name)
                                    {
                                        ...
                                        case nameof(Boolean):
                                            rootArrayList.Add(Util.ToBoolean(Convert.ToByte(value.Value.ToString())));
                                            break;
                    ...
                    if (unicodeEncoded)
                    {
                        ...
                        if (numberCounter == 4)
                        {
                            ...
                            try
                            {
                                ...
                                int unicodeChar = Convert.ToInt16(encodedValue.ToString());

                                var x = sb.Append((char)unicodeChar);
                            }
                            catch
                            {
