...
namespace TinyCLR.Json
{
    internal class JsonArray : JsonToken
    {
        ...
        public static JsonArray Serialize(Type type, object oSource) => new JsonArray((Array)oSource);

        public static JsonArray Serialize(Type type, ArrayList oSource) => new JsonArray(oSource);
